...
{
    static NSString *CellIdentifier = @"SubsystemCell";
    SubsystemViewCell *cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier];
    if (cell == nil) {
        NSArray *nib = [[NSBundle mainBundle] loadNibNamed:@"SubsystemCell" owner:self options:nil];
        cell = [nib objectAtIndex:0];
    }
    SubsystemProfile *profile = [subsystems objectAtIndex:indexPath.row];
